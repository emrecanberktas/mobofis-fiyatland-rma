...
export default function SubscriptionPlans() {
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-linear-to-r from-slate-900 via-blue-900 to-blue-800 flex items-center justify-between px-12 py-6">
      ...
      <div className="pt-20">
        {/* Banner Section */}
        <div className="w-full bg-gradient-to-r from-slate-900 via-blue-900 to-blue-800 relative overflow-hidden">
          ...
          {/* Hero Section */}
          <div className="relative z-10 px-32 pt-16 pb-12">
          ...
          <div className="max-w-[1400px] mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 mb-14">
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm text-[#002680]">
                  Yıllık %15 tasarruf edin
                </p>
              </div>
            </div>
                    ...
                    {plan.features.map((f, i) => (
                      <li key={i} className="flex items-start gap-3">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>Ek Açıklamalar Buraya</TooltipContent>
                        </Tooltip>
                      </li>
                    ))}
                  </ul>
              ...
              <Accordion type="multiple" className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger className="flex items-start gap-2 text-left">
                    <Gift className="w-6 h-6 text-[#002680]" />
                  ...
                  <AccordionContent className="flex flex-col gap-4 text-balance">
                    <p>
                      ...
                      için Mobofis'i önce 15 gün ücretsiz olarak
                      deneyebilirsiniz.
                    </p>
                    <p>
                      Mobofis'i faydalı bulur ve devam etmek isterseniz
                      paketinizi belirleyip aboneliğinizi başlatabilirsiniz. Bu
                      süre boyunca hiçbir ücret ödemezsiniz ve tüm temel
                      özelliklere erişiminiz olur. Ücretsiz deneme süresi
                      sonunda, ihtiyacınıza uygun bir pakete geçiş
                      yapabilirsiniz.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2">
                  <AccordionTrigger>
                    <Package className="w-6 h-6 text-[#002680]" />
                ...
                <AccordionItem value="item-3">
                  <AccordionTrigger>
                    <CreditCard className="w-6 h-6 text-[#002680]" />
                ...
                <AccordionItem value="item-4">
                  <AccordionTrigger>
                    <Clock3 className="w-6 h-6 text-[#002680]" />
                    Deneme süresi sonunda otomatik ödeme başlar mı?
                  </AccordionTrigger>
                  <AccordionContent className="flex flex-col gap-4 text-balance">
                    <p>
                      Evet. Ücretsiz deneme süresi sonunda kartınız tanımlıysa
                      ödeme otomatik olarak alınır. Deneme süresi sona
                      erdiğinde, sistem sizi uygun bir paket seçmeniz için
                      bilgilendirir.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-5">
                  <AccordionTrigger>
                    <XCircle className="w-6 h-6 text-[#002680]" />
                    Mobofis'i iptal etmek kolay mı?
                  </AccordionTrigger>
                  <AccordionContent className="flex flex-col gap-4 text-balance">
                    <p>
                      Evet, Mobofis üyeliğinizi istediğiniz zaman paneliniz
                      üzerinden kolayca iptal edebilirsiniz. Herhangi bir
                      taahhüt yoktur.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-6">
                  ...
                  <AccordionContent className="flex flex-col gap-4 text-balance">
                    <p>
                      ...
                      Havale/EFT gibi alternatif yöntemler için bizimle
                      iletişime geçiniz.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-7">
                  <AccordionTrigger>
                    <Users className="w-6 h-6 text-[#002680]" />
                ...
                <AccordionItem value="item-8">
                  <AccordionTrigger>
                    <Receipt className="w-6 h-6 text-[#002680]" />
                  ...
                  <AccordionContent className="flex flex-col gap-4 text-balance">
                    <p>
                      ...
                      proje kodlu Kurumsal Yönetim Sistemi adlı projemiz,
                      KDV'den istisnadır.
                    </p>
                  </AccordionContent>
                </AccordionItem>
